...
from pi_local.recorder import record_voice, list_microphones
from pi_local.audio_player import play_audio_bytes, play_beep
from pi_local.wake_word import WakeWordDetector
from pi_local.button_listener import ButtonListener
...
USE_AUDIO          = os.getenv("USE_AUDIO", "1").lower() not in ("0", "false", "no")
...
class EnderAssistant:
    ...
    def run(self):
        ...
        if USE_AUDIO:
            ...
            print("Audio disabled (USE_AUDIO=0). Not starting wake detector or button listener.")
...
if __name__ == "__main__":
    if USE_AUDIO:
        ...
        print("Running without microphone/speaker (USE_AUDIO=0).")
    EnderAssistant().run()